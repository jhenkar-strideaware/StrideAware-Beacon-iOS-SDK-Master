...
@interface STAReadBeaconParameters ()<STABeaconDeviceDelegate>

@end

@implementation STAReadBeaconParameters
...
#pragma mark - STABeaconDeviceDelegate Callbacks
...
//    [beacon writeURIBeaconURL:@"https://www.StrideAware.com/" txPower:31 WithCompletion:^(BOOL value, NSError*error)
//     {
//         if (value) {
//             NSLog(@"Success");
...
- (void)beaconDidReadAccelerationValue:(STABeaconDevice *)beacon x:(int)x y:(int)y z:(int)z
{
...
{
    if (self.mSelectBeaconDevice.isConnected) {
        [self.mSelectBeaconDevice readBeaconTxPowerWithCompletion:^(STABeaconPower value, NSError* error){
...
{
    if (self.mSelectBeaconDevice.isConnected) {
        [self.mSelectBeaconDevice writeBeaconTxPower:STABeaconPowerLevel2 withCompletion:^(BOOL value, NSError* error){
...
{
    if (self.mSelectBeaconDevice.isConnected) {
        [self.mSelectBeaconDevice writeBeaconDeviceName:@"StrideAware" withCompletion:^(BOOL value, NSError* error){
